	        ...
	        <table class="table table-bordered">
						...
						<tr>
							...
							<td colspan="3" align="center">
								<input type="radio" class="btn-check" name="ifmmPushConsentNy" id="option7" <c:if test="${item.ifmmPushConsentNy==1}">checked</c:if> value="1" autocomplete="off">
								<label class="btn btn-outline-primary" for="option7">동의</label>
								<input type="radio" class="btn-check" name="ifmmPushConsentNy" id="option8" <c:if test="${item.ifmmPushConsentNy==0}">checked</c:if> value="0" autocomplete="off">
						...
						<tr>
							<th>이메일 마케팅 수신 동의</th>
							<td colspan="3" align="center">
								<input type="radio" class="btn-check" name="ifmmEmailConsentNy" id="option9" <c:if test="${item.ifmmEmailConsentNy==1}">checked</c:if> value="1" autocomplete="off">
								<label class="btn btn-outline-primary" for="option9">동의</label>
								<input type="radio" class="btn-check" name="ifmmEmailConsentNy" id="option10" <c:if test="${item.ifmmEmailConsentNy==0}">checked</c:if> value="0" autocomplete="off">
	    ...
	    <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingThree">
	      ...
	      <div class="mb-3 row">
	        <label for="staticEmail" class="col-sm-2 col-form-label">회원 등록 날짜</label>
    			<div class="col-sm-4">
	       <input type="text" readonly class="form-control" value="<fmt:formatDate value="${item.regDateTime}" pattern="yyyy-MM-dd HH:mm:ss" />">
	       </div>
